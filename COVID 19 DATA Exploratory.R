...
p <- ggplot(zimbabwe_data, aes(x= as.Date(date), y= daily_vaccinations_per_million, group= 1)) +
 ...
 geom_line(data = south_africa_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "blue"))+
geom_line(data = angola_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, col = "orange")) +
  geom_line(data = nigeria_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, col = "pink")) +
  geom_line(data = senegal_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, col = "coral")) +
  geom_line(data = uganda_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, col = "green"))+
  geom_line(data = togo_data, aes(x= as.Date(date), y = daily_vaccinations_per_million, col = "purple"))+
  geom_line(data = namibia_data, aes(x= as.Date(date), y = daily_vaccinations_per_million, col = "coral4"))+
...
p_1 <- ggplot(brazil_data, aes(x=as.Date(date), y= daily_vaccinations_per_million, group= 1)) +
  ...
  geom_line(data = chile_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "cornsilk4"))+
  geom_line(data = argentina_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "pink"))+
  geom_line(data = panama_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "cyan"))+
  geom_line(data = bolivia_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "chocolate"))+
  geom_line(data = peru_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "green")) +
  geom_line(data = venezuela_data, aes (x = as.Date(date), y = daily_vaccinations_per_million, color = "aquamarine1")) +
  geom_line(data = colombia_data, aes (x = as.Date(date), y = daily_vaccinations_per_million, color = "darkgoldenrod4"))+
  scale_color_identity(name = "Countries",
                       ...
                       guide = "legend")
p_1 + scale_x_date(date_breaks = "1 week")
...
p_2 <- ggplot(us_data, aes(x=as.Date(date), y= daily_vaccinations_per_million, group= 1)) +
  ...
  geom_line(data = canada_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "orange")) + 
   scale_color_identity(name = "Countries",
                        breaks = c( "purple", "orange"),
                        labels = c("United States", "Canada"),
                        guide = "legend")
p_2 + scale_x_date(date_breaks = "1 week")
 
p_3 <- ggplot(australia_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, group = 1))+
  ...
  scale_color_identity(name = "Countries",
                       ...
                       labels = c("Australia"),
                       guide = "legend")
p_3 + scale_x_date(date_breaks = "1 week")

p_4 <- ggplot(italy_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, group =1))+
  geom_line(aes(color = "blue")) + theme(axis.text.x = element_text(angle = 90)) + xlab("time") + ylab("Daily Vaccinations Per Million") + ggtitle("Daily Vaccinations Per Million against time for a subset of Countries in Europe") + geom_line(data = finland_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "red"))+
  geom_line(data = poland_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "brown4"))+
  geom_line(data = norway_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "cyan4"))+
  geom_line(data = france_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "chocolate2"))+
  geom_line(data = germany_data, aes(x = as.Date(date), y = daily_vaccinations_per_million, color = "chartreuse4"))+
  geom_line(data = iceland_data, aes (x = as.Date(date), y = daily_vaccinations_per_million, color = "blueviolet")) +
  scale_color_identity(name = "Countries",
                       ...
                       guide= "legend")
p_4 +  scale_x_date(date_breaks = "1 week")